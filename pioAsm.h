...
//define SIDE_SET_HAS_ENABLE_BIT and SIDE_SET_NUM_BITS before including this
	...
	#define I_IN(_delay, _sideSet, _src, _nbits)			PIO_INSTR(0b010, _delay, _sideSet, (((_src) << 5) | (_nbits)))
	#define I_OUT(_delay, _sideSet, _dst, _nbits)			PIO_INSTR(0b011, _delay, _sideSet, (((_dst) << 5) | (_nbits)))
